...
var CodeMirror = React.createClass({
	...
	componentDidMount: function componentDidMount() {
		...
		this.codeMirror.on('keypress', this.handleKeyPress);
	...
	handleKey: function handleKey (instance, name, event) {
		this.props.onkeyHandled(instance, name, event);
	},

	handleKeyPress: function handleKeyPress () {
		this.props.onkeyPressHandled();
	},
	...
	codemirrorValueChanged: function codemirrorValueChanged(doc, change) {
		...
		this.props.onChange && this.props.onChange(newValue, change);
	},
